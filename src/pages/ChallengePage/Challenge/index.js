...
// ****************************** Search ******************************//
  ...
  search = () => {
    ...
    axios({
      method: 'post',
      url: this.props.url + '/bet/search/challenge',
    ...
    .then(function (res) {
      if (res.data.res === 'fail'){
        console.log('***/Challenge : search >', res.data.err)
      } else if (res.data.res === 'success'){
        _this.setState({ bets: res.data.bets })
      }
    })
    .catch(function (err) {
      console.log('???/Challenge : search >', err)
    })
  }
...
//******************************* Modal *******************************//
  ...
  straightOK = () => {
    if (this.state.searchCat == 'challenger') {
...
//******************************* component ******************************//
  ...
  componentDidMount() {
    console.log("hhhhhhhhhhhhhhhhhhhhhhhhhhhh",this.props);
    if (this.props.store.page == '/challenge') {
...
//******************************* Render ******************************//
  ...
  render() {
    const user_id = this.props.userState.user_id
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <h4 className="d-inline-block"> Sparlay Open Bets (Friendly Challenges)</h4>
                  { isMobile ? (
              ...
              <div className={ isMobile ? "card-body mobile-body" : "card-body desktop-body" }>
                <div className="row">
                  { !isMobile ? (
                    <div className="challenge__search">
                      <Search
                        className="challenge__search__input"
                      ...
                      <label className="challenge__search__title">Category</label>
                      <RadioGroup defaultValue="challenge" value={this.state.searchCat} size="large" className="challenge__search__sel" onChange={this.onRadioCat}>
                        <RadioButton value="wager" className="challenge__search__sel__bet">Challenges Received</RadioButton>
                        <RadioButton value="challenger" className="challenge__search__sel__bet">Challenges Sent</RadioButton>
                        <RadioButton value="accepted" className="challenge__search__sel__bet">Challenges Accepted</RadioButton>
                      </RadioGroup>

                      <label className="challenge__search__title">Type</label>
                      <RadioGroup defaultValue="all" value={this.state.searchType} size="large" className="challenge__search__sel">
                        <RadioButton value="Straight" className="challenge__search__sel__type" onClick={this.onType.bind(this, 'Straight')}>Straight</RadioButton>
                        <RadioButton value="Parlay" className="challenge__search__sel__type" onClick={this.onType.bind(this, 'Parlay')}>Parlay</RadioButton>
                      </RadioGroup>

                      <label className="challenge__search__title">Odds</label>
                      <RadioGroup defaultValue="all" value={this.state.searchBet} size="large" className="challenge__search__sel">
                        <RadioButton value="Spread" className="challenge__search__sel__bet" onClick={this.onBet.bind(this, 'Spread')}>Spread</RadioButton>
                        <RadioButton value="Line" className="challenge__search__sel__bet" onClick={this.onBet.bind(this, 'Line')}>Game Line</RadioButton>
                        <RadioButton value="O/U" className="challenge__search__sel__bet" onClick={this.onBet.bind(this, 'O/U')}>Over/Under</RadioButton>
                      </RadioGroup>

                      <label className="challenge__search__title">Currency</label>
                      <RadioGroup defaultValue="all" value={this.state.searchCurrency} size="large" className="challenge__search__sel">
                        <RadioButton value="0" className="challenge__search__sel__bet" onClick={this.onCurrency.bind(this, '0')}>Sparlay Tokens {sparlayToken()}</RadioButton>
                        <RadioButton value="1" className="challenge__search__sel__bet" onClick={this.onCurrency.bind(this, '1')}>Sparlay Funds {sparlayFund()} </RadioButton>
                      </RadioGroup>

                      <label className="challenge__search__title">Entry Fee</label>
                      <Row>
                        <Col span={11}>
                          <Input
                      ...
                      <label className="challenge__search__title">Potential Winnings</label>
                      <Row>
                        <Col span={11}>
                          <Input
                      ...
                      <div className="challenge__search__clear">
                        <a onClick={this.onResetFilters}>Reset Filters</a>
                      </div>
                    </div>
                  ) : null }

                  <div className={ isMobile ? "col-12" : "challenge__bets" }>
                    <Table className="ant-table-dark challenge__table"
                      columns={columns}
        ...
        <Modal
          ...
          footer={[
            <Button key="1" className="decline pull-left" onClick={this.straightCancel}>
              {this.state.searchCat == 'wager' ? "Decline Bet" : "Cancel Bet"}
            </Button>,
            <Button key="2" className="accept" onClick={this.straightOK}>
              {this.state.searchCat == 'wager' ? "Accept Bet" : "Keep Bet"}
            </Button>,
          ]}
        >
